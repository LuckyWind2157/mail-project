...
//            // 如果需要身份认证，则创建一个密码验证器
//            authenticator = new PasswordAuthentication(this.receiverInfo.getUserName(), this.receiverInfo.getPassword());
//        }
        //创建session
        Session session = Session.getInstance(this.receiverInfo.getProperties());
